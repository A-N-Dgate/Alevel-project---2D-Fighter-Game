...
def character_select(screen, player_data):
    ...
    player_data.set_name(name)
    player_data.load_data()
    player_data.set_characters_unlocked()
    print("Characters unlocked: %s, %s, %s" %(player_data.select_raditz(), player_data.select_frieza(), player_data.select_cell()))
    #-----
