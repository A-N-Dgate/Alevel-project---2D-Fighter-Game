...
def get_check_move(next_in, action_queue):
    try:
        while action_queue[next_in].get_name() == "default" and action_queue[next_in].get_name() == action_queue[next_in + 1].get_name(): 
            next_in += 1
        return action_queue[next_in]
    except:
        return None
