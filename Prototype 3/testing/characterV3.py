#---testing file for character classes
...
class character(my_sprite):
    def __init__(self, name, target):
        ...
        self.highest_point = False #used for moving in air
...
#---------------------------------------------------------
    ...
    def get_highest_point(self): return self.highest_point
    def set_highest_point(self, y_coordinate):
        #self._gety() doesn't work as the method is getting the y from the spritesheet 
        if y_coordinate < self.get_highest_y() + 10 and y_coordinate < self.default_y - 10:
            self.highest_point = True
        else:
            self.highest_point = False
...
#---------------------------------------------------------
    ...
    def movement(self, mode, x, y):
        ...
        if mode == "jump":
            #code goeas through here but highest point isnt being set
            self.set_highest_point(y)
...
class Vegeta(character):
    def __init__(self,target):
        ...
        self.defence = 5
        #getting the spritesheet
        path = os.path.join("spritesheets", "Vegeta", "VegetaSheet.png")
...
class Raditz_enemy(Enemy, Raditz):
    ...
    def set_queue(self, moves, player, current_time):
        ...
        if self.queue[0] == "":
            self.queue[0] = default

        for x in moves:
            x.reset_priority()
   
#---testing---
    def test_set_queue(self, a): self.queue = a
#-------------
